    ...
    <div className="space-y-6">
      ...
      {reportData && (
        <div className="space-y-6 print:space-y-4">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {formatCurrency(
                      reportData.salesOverview.averageTransaction
                    )}
                  </p>
                </div>
                <div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>PMS Report</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div>
                ...
                <div>
                  ...
                  <p className="text-xl font-semibold text-blue-600">
                    {parseFloat(
                      reportData.pmsReport.litresSold
                    ).toLocaleString()}{" "}
                    L
                  </p>
                </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Lubricant Breakdown</CardTitle>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                        <div>
                          ...
                          <p className="font-medium">
                            {parseFloat(item.openingStock).toLocaleString()}{" "}
                            units
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="font-medium text-blue-600">
                            {parseFloat(item.unitsSold).toLocaleString()} units
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground">Closing Stock</p>
                          <p className="font-medium">
                            {parseFloat(item.closingStock).toLocaleString()}{" "}
                            units
                          </p>
                        </div>
                        <div>
